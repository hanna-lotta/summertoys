...
const Home = () => {
  ...
  return (
	<div className="home">
	  ...
	  <h3 className='info-text'>Vi har sommarens leksaker för badet och lite till! Oavsett om du vill ta badet hem till dig eller för strandens utflykter. Våra produkter är noga utvalda och testade för att ge dig och dina barn den bästa möjliga upplevelsen. Vi erbjuder ett brett utbud av badleksaker, pooler och mycket mer för att göra din sommar oförglömlig.</h3>
